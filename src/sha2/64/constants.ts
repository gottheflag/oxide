 ...
 *
 * Stored as:
 * [high0, low0, high1, low1, ...]
 */
export const SHA512_INITIAL = new Uint32Array([
...
/**
 * SHA-512 / SHA-384 round constants.
 *
 * 80 × 64-bit words stored as adjacent high/low pairs.
 */
export const SHA2_64_K = new Uint32Array([
